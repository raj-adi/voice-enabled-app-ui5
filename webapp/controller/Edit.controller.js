sap.ui.define([
	...
	return Controller.extend("in.sopra.app.ui5.voicerecognition.VoiceRecognition.controller.Edit", {
		...
		onInit: function () {
			...
			this.oSpeechRecognizer.registerCommandWithOutParam("save",function(){
				this.saveCurrentItem();
			}.bind(this));
			
			this.getRouter().getRoute("edit").attachPatternMatched(this._detailMatched, this);
		},
